...
class TCODetailsScreenWidget extends StatefulWidget {
  const TCODetailsScreenWidget({
    Key? key,
  ...
  @override
  _TCODetailsScreenWidgetState createState() => _TCODetailsScreenWidgetState();
}

class _TCODetailsScreenWidgetState extends State<TCODetailsScreenWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final tCODetailsScreenFPNTCODetailsResponse = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                          ...
                          builder: (context) {
                            final tcoHeaderItems = functions
                                .getTCOHeaderData(FPNTCODetailsCall.vData(
                                  tCODetailsScreenFPNTCODetailsResponse
                                      .jsonBody,
                                ))
                                .toList();
                            return Row(
