...
class ConfirmFeedbackPageCopyWidget extends StatefulWidget {
  const ConfirmFeedbackPageCopyWidget({
    Key? key,
  ...
  @override
  _ConfirmFeedbackPageCopyWidgetState createState() =>
      _ConfirmFeedbackPageCopyWidgetState();
}

class _ConfirmFeedbackPageCopyWidgetState
    extends State<ConfirmFeedbackPageCopyWidget> {
                      ...
                      children: [
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              if (FFAppState().selectedRecipient == null ||
